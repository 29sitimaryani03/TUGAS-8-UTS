...
Route::post('blog/filter', [ClientController::class, 'filter']);
Route::get('single', [ClientController::class, 'showSingle']);
Route::get('single/{artikel}', [ClientController::class, 'showSingle']);
Route::post('single/{artikel}', [KomentarController::class, 'store']);
