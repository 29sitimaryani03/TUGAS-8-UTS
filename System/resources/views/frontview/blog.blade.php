        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-5" data-aos="fade-up">
              ...
              <p>" Liburan membuat kamu melupakan permasalahan kehidupan dan berfokus pada keindahan kehidupan, karena itu berliburlah agar kamu berbahagia."</p>
        ...
        @foreach ($list_artikel as $artikel)
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="{{url('single', $artikel->id)}}">
                <img src="{{url('public')}}/images/img_1.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                
                <h2><a href="{{url('single', $artikel->id)}}">{{$artikel->judul}}</a></h2>
